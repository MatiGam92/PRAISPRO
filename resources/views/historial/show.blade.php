<x-app-layout>
    ...
    {{-- ===============================
        ✅ [NUEVO 1] Alpine container
    ================================ --}}
    <div 
        x-data="{ openModal:false, productoToDelete:null }"
    >
        ...
        >
            ...
            <div class="bg-[#1f0f0b] p-6 rounded-lg border border-red-500 w-[400px]">

                <h2 class="text-lg text-gray-300 font-bold mb-4">
                    ¿Eliminar cálculo?
                </h2>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    {{-- FORM DELETE REAL --}}
                    <form
                        :action="`/historial/${productoToDelete}`"
                        method="POST"
                    >
                        @csrf
                        @method('DELETE')
