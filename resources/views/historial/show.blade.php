...
<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto px-6 pt-3 pb-32">

        {{-- Card --}}
        <div class="bg-black/90 text-white p-6 rounded-xl border border-gray-700">
                ...
                <div>
                    @if ($producto->photo)
                        <img
                            ...
                            class="w-full max-h-[360px] object-cover rounded-lg border border-gray-700"
                        >
                    @else
                        <div
                ...
                <div class="flex flex-col justify-between gap-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div class="bg-gray-900 p-3 rounded-lg border border-gray-700 col-span-2">
                    ...
                    <div class="bg-green-900/30 border border-green-700 p-4 rounded-lg">
                        <p class="text-green-300 text-xs">Precio final</p>
            ...
            {{-- =========================
                ACCIONES
            ========================= --}}
            <div class="mt-6 flex justify-between items-center pt-4 border-t border-gray-700 text-sm">

                <a
                    href="{{ route('calculator', $producto->id) }}"
                    class="text-gray-200 hover:text-green-500 transition"
                >
                    Editar
                </a>
